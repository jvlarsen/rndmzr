...
const getGraphColors = () => {
  return [
      ...
      {color: 'rgb(47, 245, 60)', borderColor: 'rgba(0,255,0,1)'},
      {color: 'rgba(0,0,255,1)', borderColor: 'rgba(0,0,255,1)'},
      {color: 'rgba(100,0,0,1)', borderColor: 'rgba(100,0,0,1)'},
      {color: 'rgba(246, 250, 17)', borderColor: 'green'},
      {color: 'rgb(247, 15, 240)', borderColor: 'orange'},
      {color: 'rgba(6, 64, 10)', borderColor: 'purple'},
